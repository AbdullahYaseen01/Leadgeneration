...
NICHES = [
    ...
    "Plumbing Companies",
    "Heating Installation SMEs",
    "Air Conditioning & Ventilation Companies",
    "HVAC / Building Services SMEs",
    "Building Automation Companies",
    "KNX / Smart Building Integrators",
    "Plant Engineering SMEs",
    "Pipeline Construction Companies",
    "Switchgear Manufacturing / Assembly Companies",
    "Industrial Installation Companies",
    "Mechanical Engineering SMEs",
    "Automation / PLC Companies",
    "Construction Companies (Building Construction SMEs)",
    "Civil Engineering SMEs",
    "Road Construction SMEs",
    "Interior Fit-Out Companies",
    "Plastering & Stucco Companies",
    "Painting Companies",
    "Flooring Installation Companies",
    "Tiling Companies",
    "Carpentry / Joinery Companies",
    "Roofing Companies",
    "Facade Construction SMEs",
    "Waterproofing Companies",
    "Sheet Metal / Flashing Companies",
    "Timber Construction / Carpentry Firms",
    "Scaffolding Companies",
    "Garden & Landscape Construction SMEs",
    "Fire Protection Companies",
    "Asbestos Remediation Companies",
    "Insulation Companies",
    "Joint Sealing / Caulking Companies",
    "Construction Cleaning Companies",
    "Metal Construction SMEs",
    "Steel Construction SMEs",
